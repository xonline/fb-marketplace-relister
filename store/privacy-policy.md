...
| `https://relist.nowoly.com/*` | Send listing content to our AI relay endpoint (Provided AI mode for Pro subscribers) and verify Pro subscription status via ExtPay. |

---

## 5. Payments via ExtPay / Stripe

Pro subscriptions are managed through **ExtPay**, which uses **Stripe** as its payment processor.

- Payment is handled entirely by Stripe and ExtPay — we never receive, see, or store your credit card or payment details.
- ExtPay stores a record of your subscription status (active/inactive) linked to your email address, to allow the extension to verify your Pro status.
- Your payment data is governed by [Stripe's Privacy Policy](https://stripe.com/privacy) and [ExtPay's Privacy Policy](https://extpay.app/privacy).
- To cancel your subscription or request deletion of your payment data, contact ExtPay or manage your subscription via the extension's Options page.
...
- Store your credit card or payment information — payments are handled entirely by Stripe/ExtPay.
